...
export function Result({ athletic, profile }) {
  ...
  console.log('athletic', athletic)
  console.log('criteriaListasdasdasd', criteriaList)
  return (
    <div>
      ...
      <Box>
          ...
          >
            ...
            <Stack alignItems="center" spacing={1}>
              ...
              >
                ...
                >
                  {data && data.length > 0
                    ? data.reduce((total, curr) => total + curr.PointPlay, 0)
                    : 0}
                </Typography>
              </Box>
            </Stack>
        ...
        <Box>
          <ResultList data={data} criteriaList={criteriaList} />
        </Box>
      </Box>
    </div>
  )
